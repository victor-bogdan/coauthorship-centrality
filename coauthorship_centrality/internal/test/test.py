...
def test_year_coauthorship_centrality(year, centrality_measure, data_type, data_path):
    ...
    with open(path_string, "r", encoding="utf-8-sig") as file:
        ...
        year_coauthorship_centrality_data = coauthorship_centrality_analyzer.\
            get_year_coauthorship_centrality(year_graph_data, centrality_measure, data_type)
